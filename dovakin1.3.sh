...
echo "     .___                   __   .__  "
echo "   __| _/_______  _______  |  | _|__|  ___ Ver 1.3"
echo "  / __ |/  _ \  \/ /\__  \ |  |/ /  |/    \  airmon-zc"
echo " / /_/ (  <_> )   /  / __ \|    <|  |   |  \ "
echo " \____ |\____/ \_/  (____  /__|_ \__|___|  / "
echo "      \/                 \/     \/       \/ "
echo " $(tput setaf 1) To make this script executable use chmod +x dovakin1.3.sh $(tput sgr0)"
echo ""
